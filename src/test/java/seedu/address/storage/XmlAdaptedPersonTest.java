...
public class XmlAdaptedPersonTest {
    ...
    private static final List<XmlAdaptedWeight> VALID_WEIGHTS = BENSON.getWeights().stream()
            .map(XmlAdaptedWeight::new)
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        XmlAdaptedPerson person =
                new XmlAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_HEIGHT,
                        VALID_WEIGHT, VALID_GENDER, VALID_AGE, VALID_WEIGHTS, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        XmlAdaptedPerson person = new XmlAdaptedPerson(null, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_HEIGHT, VALID_WEIGHT, VALID_GENDER, VALID_AGE, VALID_WEIGHTS, VALID_TAGS);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        XmlAdaptedPerson person =
                new XmlAdaptedPerson(VALID_NAME, INVALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_HEIGHT, VALID_WEIGHT, VALID_GENDER, VALID_AGE, VALID_WEIGHTS, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        XmlAdaptedPerson person = new XmlAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                null, VALID_HEIGHT, VALID_WEIGHT, VALID_GENDER, VALID_AGE, VALID_WEIGHTS, VALID_TAGS);
    ...
    public void toModelType_invalidHeight_throwsIllegalValueException() {
        XmlAdaptedPerson person =
                new XmlAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        INVALID_HEIGHT, VALID_WEIGHT, VALID_GENDER, VALID_AGE, VALID_WEIGHTS, VALID_TAGS);
    ...
    public void toModelType_nullHeight_throwsIllegalValueException() {
        XmlAdaptedPerson person = new XmlAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, null, VALID_WEIGHT, VALID_GENDER, VALID_AGE, VALID_WEIGHTS, VALID_TAGS);
    ...
    public void toModelType_invalidWeight_throwsIllegalValueException() {
        XmlAdaptedPerson person =
                new XmlAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_HEIGHT, INVALID_WEIGHT, VALID_GENDER, VALID_AGE, VALID_WEIGHTS, VALID_TAGS);
    ...
    public void toModelType_nullWeight_throwsIllegalValueException() {
        XmlAdaptedPerson person = new XmlAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_HEIGHT, null, VALID_GENDER, VALID_AGE, VALID_WEIGHTS, VALID_TAGS);
    ...
    public void toModelType_invalidGender_throwsIllegalValueException() {
        XmlAdaptedPerson person =
                new XmlAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_HEIGHT, VALID_WEIGHT, INVALID_GENDER, VALID_AGE, VALID_WEIGHTS, VALID_TAGS);
    ...
    public void toModelType_nullGender_throwsIllegalValueException() {
        XmlAdaptedPerson person = new XmlAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_HEIGHT, VALID_WEIGHT, null, VALID_AGE, VALID_WEIGHTS, VALID_TAGS);
    ...
    public void toModelType_invalidAge_throwsIllegalValueException() {
        XmlAdaptedPerson person =
                new XmlAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_HEIGHT, VALID_WEIGHT, VALID_GENDER, INVALID_AGE, VALID_WEIGHTS, VALID_TAGS);
    ...
    public void toModelType_nullAge_throwsIllegalValueException() {
        XmlAdaptedPerson person = new XmlAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                VALID_ADDRESS, VALID_HEIGHT, VALID_WEIGHT, VALID_GENDER, null, VALID_WEIGHTS, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        XmlAdaptedPerson person =
                new XmlAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_HEIGHT, VALID_WEIGHT, VALID_GENDER, VALID_AGE, VALID_WEIGHTS, invalidTags);
